...
const (
	...
	// an endpoint.
	DefaultSendBufferSize = 32 << 10 // 32KB
...
func NewProtocol() stack.TransportProtocol {
	return &protocol{
		sendBufferSize: tcpip.StackSendBufferSizeOption{MinBufferSize, DefaultSendBufferSize, MaxBufferSize},
		recvBufferSize: tcpip.StackReceiveBufferSizeOption{MinBufferSize, DefaultReceiveBufferSize, MaxBufferSize},
	}
}
